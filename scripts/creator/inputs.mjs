...
document.getElementById('remaining-exp').addEventListener('change', function () {
  ...
  this.value =
    parseInt(yearExp.value || 0) + parseInt(raceExp.value || 0) + parseInt(totalExp.value || 0) - getAllSkillsCost()
})

document.getElementById('race-attribute-points').addEventListener('change', function () {
  ...
  const remainingAttributePoints = document.getElementById('remaining-attribute-points')

  remainingAttributePoints.value =
    parseInt(totalAttributePoints.value || 0) + parseInt(yearAttributePoints.value || 0) + parseInt(this.value || 0)
})

document.getElementById('year-attribute-points').addEventListener('change', function () {
  const raceAttributePoints = document.getElementById('race-attribute-points')
  const totalAttributePoints = document.getElementById('total-attribute-points')
  const remainingAttributePoints = document.getElementById('remaining-attribute-points')

  remainingAttributePoints.value =
    parseInt(totalAttributePoints.value || 0) + parseInt(raceAttributePoints.value || 0) + parseInt(this.value || 0)
})
...
document.getElementById('total-attribute-points').addEventListener('change', function () {
  const remainingAttributePoints = document.getElementById('remaining-attribute-points')

  remainingAttributePoints.dispatchEvent(new Event('change'))
})

document.getElementById('remaining-attribute-points').addEventListener('change', function () {
  const yearAttributePoints = document.getElementById('year-attribute-points')
  const raceAttributePoints = document.getElementById('race-attribute-points')
  const totalAttributePoints = document.getElementById('total-attribute-points')
...
document.getElementById('max-hp').addEventListener('change', function () {
  ...
  this.value = 3 * (parseInt(body.value || 0) + parseInt(mind.value || 0) + parseInt(soul.value || 0))
})
...
document.getElementById('initiative').addEventListener('change', function () {
  ...
  this.value =
    parseInt(mind.value || 0) + parseInt(reflexes?.value || 0) + parseInt(perception?.value || 0) + 2 * combatReadyLvl
})
